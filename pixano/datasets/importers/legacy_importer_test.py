...
class LegacyImporterTestCase(unittest.TestCase):
    def setUp(self):
        #TODO make a small legacy dataset to test
        self.input_dirs = {"" : Path("")}
        ...
        with tempfile.TemporaryDirectory() as library_dir:
            ...
            for r in ds.to_batches():
                ...
                self.assertGreaterEqual(
                    len(db), 1, "Dataframe should have at least 1rows."
                )
                self.assertIn(
