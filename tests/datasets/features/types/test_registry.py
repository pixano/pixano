...
from pixano.datasets.features.types.base_type import BaseType
from pixano.datasets.features.types.registry import _TYPES_REGISTRY, _register_type_internal
...
def test_register_type_internal():
    ...
    with pytest.raises(
        ValueError,
        match=(
            "Type <class 'tests.datasets.features.types.test_registry.test_register_type_internal."
