...
from pixano.datasets.features import BaseSchema
from pixano.datasets.features.schemas.registry import (
...
def test_register_schema_internal():
    ...
    with pytest.raises(
        ValueError,
        match=(
            "Schema <class 'tests.datasets.features.schemas.test_registry.test_register_schema_internal.<locals>."
    ...
    with pytest.raises(
        ValueError,
        match=(
            "Schema <class 'tests.datasets.features.schemas.test_registry.test_register_schema_internal."
...
def test_register_schema():
    ...
    with pytest.raises(
        ValueError,
        match=(
            "Schema <class 'tests.datasets.features.schemas.test_registry.test_register_schema.<locals>."
