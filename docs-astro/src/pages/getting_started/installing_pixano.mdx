...
Pixano works on Linux and macOS. It should also work on Windows, but this has not been tested officially.
>>>>>>> 9d8de36e (refactor: streamline release Docker image and install docs)
</Callout>
