...
![Pixano home page](/pixano/assets/user/app_home.png)
...
![Dataset Card](/pixano/assets/user/dataset_card.png)
...
![Pixano dataset page](/pixano/assets/user/app_dataset.png)
...
![Dataset filter](/pixano/assets/user/dataset_filter.png)
...
![Dataset semantic search](/pixano/assets/user/dataset_semsearch.png)

If you have [computed semantic embeddings](/pixano/tutorials/semantic_search/), semantic search will be displayed.
...
![Pixano dataset dashboard](/pixano/assets/user/app_dashboard.png)
...
![Pixano item view - scene](/pixano/assets/user/item_scene.png)
...
![Pixano item view - objects](/pixano/assets/user/item_objects.png)
...
![Pixano item view - objects options](/pixano/assets/user/objects_options.png)
...
![Pixano Toolbar - Creation prompt](/pixano/assets/user/creation_prompt.png)
...
![Pixano tools - associate](/pixano/assets/user/annotation_associate.png)
...
![Pixano item view - Video](/pixano/assets/user/item_video.png)
...
![Pixano item view - Video Inspector](/pixano/assets/user/video_inspector.png)
...
![Pixano item view - Track Item](/pixano/assets/user/track_item.png)
...
![Pixano item view - VQA](/pixano/assets/user/item_vqa.png)
...
![VQA Model Settings](/pixano/assets/user/vqa_model_settings.png)
...
![Pixano item view - EntityLinking](/pixano/assets/user/item_entity_linking.png)
...
![Smart Model panel](/pixano/assets/user/smart_model.png)

Here you can choose a model for segmentation. You can choose either a local model (which requires precomputed embeddings and a local model, see [Interactive segmentation](/pixano/tutorials/interactive_segmentation/)), or a segmentation model provided by Pixano Inference.
