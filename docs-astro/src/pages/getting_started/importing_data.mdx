...
Pixano 0.8 imports and exports datasets as plain files — no Python required. You describe your data in a JSONL file, describe your schema in a YAML file, and run one command. This page covers both the import and export formats.
...
- **Jobs**: resuming, cancelling and rolling back an import
