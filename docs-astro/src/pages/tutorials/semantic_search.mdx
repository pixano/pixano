...
First, we need to pre-compute the embeddings using LanceDB and Pixano. We will use the Health Images dataset defined in the [Build and query a dataset](/pixano/tutorials/dataset/) tutorial.
...
Now you are all set to use the semantic search, follow the [using the app](/pixano/getting_started/using_the_app/) guide!
