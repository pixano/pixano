...
title: "Build and query a dataset"
section: tutorials
---
...
<Callout type="tip" title="New to Pixano?">
If you just want to get a dataset running quickly, start with the [Quickstart](/pixano/getting_started/quickstart/) guide.
</Callout>
...
<Callout type="tip" title="CLI alternative">
...
See the [quickstart guide](/pixano/getting_started/quickstart/) for the canonical `metadata.jsonl` format details.
</Callout>
...
Then we can call the endpoints of the REST API. To have the complete list of endpoints, we can have take a look at the Swagger docs [http://localhost:7492/docs](http://localhost:7492/docs) or look at the relevant [documentation](/pixano/api_reference/).
