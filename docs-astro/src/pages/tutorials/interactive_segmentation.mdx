...
We will use the Health Images dataset defined in the [Build and query a dataset](/pixano/tutorials/dataset/) tutorial.
...
Now you are all set to use SAM, check the "Smart segmentation tool" section of the [using the app](/pixano/getting_started/using_the_app/) guide!
