...
The schema lives in `dataset.yaml` at the source root:
...
- [Object Detection](/pixano/cookbook/object_detection/) — image-only detection with pre-annotation
- [API Reference](/pixano/api_reference/) — full Python API documentation

<PrevNext
  prev={{ title: "Visual Question Answering", href: "/cookbook/vqa/" }}
/>
