...
class DatasetBuilder(ABC):
    ...
    def _flush_accumulated(
        ...
        self._validate_batch(batch, dataset)
    ...
    def _validate_batch(
        ...
        """Validate a flushed batch before insertion.

        Subclasses can override this hook to enforce builder-specific invariants
        without coupling the base orchestration to domain-specific policies.
        """
