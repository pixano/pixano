...
from pixano.api.display import display_cli, display_colab, display_ipython
from pixano.api.main import create_app
from pixano.api.routers import API_PREFIXES
...
task_functions = {
    "colab": _create_notebook_task,
    "ipython": _create_notebook_task,
    "none": asyncio.run,
}
display_functions = {
    "colab": display_colab,
...
class App:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            data_dir: Root data directory containing library/ and
    ...
    def display(self, height: int = 1000) -> None:
        ...
        while not self.server.started:
            task_functions[self.get_env()](asyncio.sleep(0.1))  # type: ignore[operator, call-overload]
